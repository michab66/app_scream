...
extends FirstClassObject
{
    ...
    private static Thunk _add( Environment e, Number total, Cons rest, Cont_<FirstClassObject> c )
            throws RuntimeX
    {
        if ( rest == Cons.NIL )
    ...
    private static Thunk _subtract( Environment e, Number total, Cons rest, Cont_<FirstClassObject> c )
            throws RuntimeX
    {
        if ( rest == Cons.NIL )
            return c.accept( total );
    ...
    private static Thunk _multiply( Environment e, Number total, Cons rest, Cont_<FirstClassObject> c )
            throws RuntimeX
    {
        if ( rest == Cons.NIL )
            return c.accept( total );
    ...
    private static Thunk _divide( Environment e, Number total, Cons rest, Cont_<FirstClassObject> c )
            throws RuntimeX
    {
        if ( rest == Cons.NIL )
            return c.accept( total );
