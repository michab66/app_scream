    ...
    extends Operation
{
     ...
     * {@link #_executeImpl(Environment, Cons, Scc)} for execution of the
     ...
     */
    @Override
    protected final Thunk _execute( Environment e, Cons args, Scc<FirstClassObject> c )
            throws RuntimeX
    {
        // Execute in our _closure.
        Scc<Cons> cc = evaluated -> _executeImpl(
                _closure,
                evaluated,
                c );
