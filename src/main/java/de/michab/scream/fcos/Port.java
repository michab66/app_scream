    ...
    extends FirstClassObject
{
     ...
     */
    public Port( String name, PortType inout )
            throws RuntimeX
    {
        _type = inout;
        _name = name;
        ...
        try
        {
            if ( PortType.Input == inout )
            {
                _inPort = new InputStreamReader(
                        new FileInputStream( name ) );
            }
            else if ( PortType.Output == inout )
            {
     ...
     * @throws RuntimeX If an error occurred.
     */
    public Port( URL name, PortType inout )
            throws RuntimeX
    {
        _type = inout;
     ...
     *
     * @return {@code true} if this is an input port, {@code false}
     * otherwise.
     */
    public boolean isInputPort()
    {
        return _type == PortType.Input;
    }

    /**
     * Tests whether this is an output port.
     *
     * @return {@code true} if this is an output port, {@code false}
     * otherwise.
     */
    public boolean isOutputPort()
    {
        return _type == PortType.Output;
    }
